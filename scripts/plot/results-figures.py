...
plt.errorbar(x, y, linestyle='None', color='#098A63',
    marker='o', label='balanced')
plt.errorbar(x, y, [y - el, eh - y], linestyle='None',
    ecolor='#098A63', capsize=3)
plt.errorbar(x, y1, linestyle='None', color='#3F2B78',
    marker='o', label='imbalanced')
plt.errorbar(x, y1, [y1 - el1, eh1 - y1], linestyle='None',
...
# %%
fig, ax = plt.subplots(figsize=(10, 4), dpi=500)
plt.errorbar(x, y2, linestyle='None', color='#098A63',
    marker='o', label='balanced')
plt.errorbar(x, y2, [y2 - el2, eh2 - y2], linestyle='None',
    ecolor='#098A63', capsize=3)
plt.errorbar(x, y, linestyle='None', color='#3F2B78',
    marker='o', label='imbalanced, without k optimisation')
plt.errorbar(x, y, [y - el, eh - y], linestyle='None',
    ecolor='#3F2B78', capsize=3)
plt.errorbar(x, y1, linestyle='None', color='C0', marker='o',
